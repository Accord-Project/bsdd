...
TODO: refer to GraphQL recommendation that each node should have ID, and these should be declared as type ~ID~ [[https://graphql.org/learn/global-object-identification/#node-interface]].
