...
:PROPERTIES:
:CUSTOM_ID: cool-uris-dont-change
:END:
We noticed that search results for the same queries is time-dependent. 
...
(To check the difference, we compare the versions of README.org dated February 2023 and May 2023).
#+begin_src sh
@@ -1033 +1090,2 @@
