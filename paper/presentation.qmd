...
**12385** ```Properties``` are declared as ```isDynamic``` 
...
- address and resolve more data quality issues, including 
  ...
  - parse out enumeration values from `Property/ClassificationProperty` descriptions and creation of corresponding `PropertyValue` lists
