...
IfcCableSegment has also semantic URI: 
...
## Improve URL Structure and Consistency (1/2){.smaller}
...
## Remove the overlap of Entity Classes with classificationTypes {.smaller}
...
## URI for ClassificationProperty {.smaller}
...
## Improve Representation of ```PropertyValues```  {.smaller}
...
## Improve representation of ```predefinedValue```{.smaller}
...
- Drafting [SOML schema](https://platform.ontotext.com/semantic-objects/soml/index.html)
