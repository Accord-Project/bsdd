...
## Modelling issues (1/8): Unify Solutions to Model Complex Properties {.smaller}
...
## Modelling issues (2/8): Improve Modelling of Dynamic Properties {.smaller}
...
## Modelling issues (4/8): Add More Entities {.smaller}
...
## Modelling issues (5/8): Use Class Inheritance  {.smaller}
...
## Modelling issues (6/8): Improve Representation of ```PropertyValues```  {.smaller}
...
## Modelling issues (7/8): Improve representation of ```predefinedValue```{.smaller}
...
## Implementing Improvements {.smaller}
...
The results are available at the endpoint [![](../img/graphdb-sparql.png)](https://bsdd.ontotext.com/graphdb/sparql/)
